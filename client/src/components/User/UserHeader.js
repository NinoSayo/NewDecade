    ...
    <div className="container">
      <div className="d-flex justify-content-between topbar py-2">
        <div className="d-flex align-items-center flex-shrink-0 topbar-info">
          ...
          <a href="fake_url" className="me-4 text-secondary"><i className="fas fa-phone-alt me-2 text-dark" />+01234567890</a>
          <a href="fake_url" className="text-secondary"><i className="fas fa-envelope me-2 text-dark" />NewDecade@gmail.com</a>
        </div>
        ...
        <div className="d-flex align-items-center justify-content-center topbar-icon">
          <a href="fake_url" className="me-4"><i className="fab fa-facebook-f text-dark" /></a>
          <a href="fake_url" className="me-4"><i className="fab fa-twitter text-dark" /></a>
          <a href="fake_url" className="me-4"><i className="fab fa-instagram text-dark" /></a>
          <a href="fake_url" className><i className="fab fa-linkedin-in text-dark" /></a>
        </div>
      </div>
    </div>
  </div>
