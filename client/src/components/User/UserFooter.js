...
const UserFooter = () => {
      ...
      <div className="row g-4 footer-inner">
        <div className="col-lg-3 col-md-6">
          <div className="footer-item">
            ...
            <p className="mb-0"><a className href="fake_url">PestKit </a> © 2023 All Right Reserved.</p>
          </div>
        </div>
        <div className="col-lg-3 col-md-6">
          <div className="footer-item">
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-4 text-center text-md-start mb-3 mb-md-0">
          <a href="fake_url" className="text-primary mb-0 display-6">New<span className="text-white">Decade</span></a>
        </div>
  ...
  {/* Copyright End */}
  {/* Back to Top */}
  <a href="fake_url" className="btn btn-primary rounded-circle border-3 back-to-top"><i className="fa fa-arrow-up" /></a>
</div>
